...
function ProgressBar({ value, max, min, theme }: { value: number; max: number; min: number; theme: SnakeTheme }) {
      ...
      <div style={{ display: "flex", gap: 16, alignItems: "flex-start", width: "100%", maxWidth: canvasW + 240 }}>
              ...
              <div style={{ width: 300, padding: 24, textAlign: "center", fontFamily: "inherit" }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between" }}>
                  ...
                  {introStep < INTRO_STEPS.length - 1
                    ...
                    : <button onClick={closeIntro} style={{ ...primaryButtonStyle, background: "#166534", border: "1px solid #22c55e", color: "#f0fdf4" }}>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 14, minWidth: 200 }}>
          ...
          <div style={{ ...panelStyle, padding: "16px 18px" }}>
            <div style={{ fontSize: 11, fontWeight: 700, color: theme.textSoft, textTransform: "uppercase", letterSpacing: 1, marginBottom: 8 }}>Snake Length</div>
          ...
          <div
            ...
            <div style={{ fontSize: 11, fontWeight: 700, color: theme.textSoft, textTransform: "uppercase", letterSpacing: 1, marginBottom: 6 }}>Last Answer</div>
            {feedback
          ...
          <div style={{ ...panelStyle, padding: "16px 18px" }}>
            <div style={{ fontSize: 11, fontWeight: 700, color: theme.textSoft, textTransform: "uppercase", letterSpacing: 1, marginBottom: 10 }}>IMF Types</div>
            {IMF_PROMPTS.map(({ key, label }) => (
              <div key={key} style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 7 }}>
                ...
                <span style={{ fontSize: 12, color: prompt?.key === key ? IMF_COLORS[key] : theme.textMuted, fontWeight: prompt?.key === key ? 700 : 400 }}>
                  {label}
                </span>
                {prompt?.key === key && (
          ...
          <div style={{ ...panelStyle, padding: "16px 18px" }}>
            <div style={{ fontSize: 11, fontWeight: 700, color: theme.textSoft, textTransform: "uppercase", letterSpacing: 1, marginBottom: 10 }}>Progress</div>
            <div style={{ fontSize: 13, color: theme.textMuted, marginBottom: 4 }}>
              <span style={{ color: theme.textStrong, fontWeight: 700 }}>{used.size}</span> compounds eaten
            </div>
            <div style={{ fontSize: 13, color: theme.textMuted }}>
              <span style={{ color: theme.textStrong, fontWeight: 700 }}>{COMPOUNDS.length - used.size}</span> remaining
            </div>
          </div>

          <div style={{ ...panelStyle, padding: "16px 18px" }}>
            <div style={{ fontSize: 11, fontWeight: 700, color: theme.textSoft, textTransform: "uppercase", letterSpacing: 1, marginBottom: 10 }}>Controls</div>
            {[["↑ ↓ ← → / WASD", "Move"], ["Space", "Restart"]].map(([key, action]) => (
              <div key={key} style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
                <span style={{ fontSize: 12, color: theme.keycapText, background: theme.keycapBg, padding: "2px 8px", borderRadius: 4, fontFamily: "monospace", border: `1px solid ${theme.keycapBorder}` }}>{key}</span>
                <span style={{ fontSize: 12, color: theme.textMuted }}>{action}</span>
              </div>
            ))}
          </div>

          <div style={{ ...panelStyle, padding: "14px 18px" }}>
            <div style={{ fontSize: 11, fontWeight: 700, color: theme.textSoft, textTransform: "uppercase", letterSpacing: 1, marginBottom: 6 }}>Current Mode</div>
            <div style={{ fontSize: 13, color: theme.titleAccent, fontWeight: 700 }}>
